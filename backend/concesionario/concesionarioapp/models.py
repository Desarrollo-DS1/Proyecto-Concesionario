...
class Modelo(models.Model):
    ...
    ('Gas Natural', 'Gas Natural'), ('Gas Licuado', 'Gas licuado')), blank=True, null=True)
...
class Modelo(models.Model):
    ...
    anho = models.IntegerField('Año del Modelo', blank=True, null=True)
    carroceria = models.CharField('Carrocería', max_length=30, choices=(
    ('Sedan', 'Sedan'), ('Station Wagon', 'Station Wagon'), ('Pickup', 'Pickup'), ('SUV', 'SUV'), ('Van', 'Van'),
    ('Convertible', 'Convertible'), ('Camion', 'Camion'), ('Camioneta', 'Camioneta')), blank=True, null=True)
    cilindraje = models.IntegerField('Cilindraje', blank=True, null=True)
    potencia = models.IntegerField('Potencia', blank=True, null=True)
    combustible = models.CharField('Combustible', choices=(
    ('Gasolina', 'Gasolina'), ('Diesel', 'Diesel'), ('Eléctrico', 'Eléctrico'), ('Híbrido', 'Híbrido'),
    ('Gas Natural', 'Gas Natural')), blank=True, null=True)
    numero_pasajeros = models.IntegerField('Número de Pasajeros', blank=True, null=True)
