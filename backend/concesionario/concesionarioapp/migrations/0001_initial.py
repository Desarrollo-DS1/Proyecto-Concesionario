    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('combustible', models.CharField(blank=True, choices=[('Gasolina', 'Gasolina'), ('Diesel', 'Diesel'), ('Electrico', 'Electrico'), ('Hibrido', 'Hibrido'), ('Gas', 'Gas'), ('Gas Natural', 'Gas Natural'), ('Gas Licuado', 'Gas licuado')], null=True, verbose_name='Combustible')),
