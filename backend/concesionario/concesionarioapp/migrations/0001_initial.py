    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_vencimiento', models.DateField(default=datetime.datetime(2023, 11, 20, 22, 32, 21, 304872), verbose_name='Fecha de Vencimiento')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_creacion', models.DateField(auto_now_add=True, verbose_name='Fecha de Creación')),
                ('fecha_entrega_esperada', models.DateField(default=datetime.datetime(2023, 11, 20, 22, 32, 21, 303796), verbose_name='Fecha de Entrega Esperada')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carro', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='concesionarioapp.carro')),
                ('extras', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='concesionarioapp.extra')),
        ...
        migrations.AddField(
            model_name='venta',
            name='carros',
            field=models.ManyToManyField(through='concesionarioapp.Venta_Carro', to='concesionarioapp.carro'),
        ),
        migrations.CreateModel(
            name='Trabajo',
            fields=[
                ...
                ('orden_trabajo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='concesionarioapp.orden_trabajo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modelos', models.ManyToManyField(to='concesionarioapp.modelo')),
                ('sucursales', models.ManyToManyField(through='concesionarioapp.InventarioRepuesto', to='concesionarioapp.sucursal')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='concesionarioapp.repuesto'),
        ),
        migrations.AddField(
            model_name='inventariorepuesto',
            name='repuesto',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='concesionarioapp.repuesto'),
        ),
        migrations.AddField(
            model_name='inventariorepuesto',
            name='sucursal',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='concesionarioapp.sucursal'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='carro',
            name='color_carro',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='concesionarioapp.color'),
        ),
        migrations.AddField(
            model_name='carro',
            name='modelo_carro',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='concesionarioapp.modelo'),
        ),
        migrations.AddField(
            model_name='carro',
            name='sucursal_carro',
