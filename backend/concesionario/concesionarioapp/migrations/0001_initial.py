    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anho', models.IntegerField(blank=True, null=True, verbose_name='Año del Modelo')),
                ('carroceria', models.CharField(blank=True, choices=[('Sedan', 'Sedan'), ('Station Wagon', 'Station Wagon'), ('Pickup', 'Pickup'), ('SUV', 'SUV'), ('Van', 'Van'), ('Convertible', 'Convertible'), ('Camion', 'Camion'), ('Camioneta', 'Camioneta')], max_length=30, null=True, verbose_name='Carrocería')),
                ...
                ('combustible', models.CharField(blank=True, choices=[('Gasolina', 'Gasolina'), ('Diesel', 'Diesel'), ('Eléctrico', 'Eléctrico'), ('Híbrido', 'Híbrido'), ('Gas Natural', 'Gas Natural')], null=True, verbose_name='Combustible')),
                ('numero_pasajeros', models.IntegerField(blank=True, null=True, verbose_name='Número de Pasajeros')),
                ('precio_base', models.DecimalField(blank=True, decimal_places=2, max_digits=14, null=True, verbose_name='Precio Base')),
            ],
            options={
                'verbose_name': 'Modelo',
        ...
        migrations.AddField(
            model_name='venta',
            name='vehiculos',
            field=models.ManyToManyField(through='concesionarioapp.Venta_Vehiculo', to='concesionarioapp.vehiculo'),
        ),
        migrations.AddField(
            model_name='venta',
            name='cliente',
