# Generated by Django 4.2.6 on 2023-12-15 17:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_entrega_esperada', models.DateField(default=datetime.date(2024, 1, 4), verbose_name='Fecha de Entrega Esperada')),
                ('fecha_entrega_real', models.DateField(blank=True, null=True, verbose_name='Fecha de Entrega Real')),
                ('estado_reparacion', models.BooleanField(default=False, verbose_name='Estado de la Reparación')),
        ...
        migrations.CreateModel(
            name='Servicio',
            fields=[
                ('id_servicio', models.AutoField(primary_key=True, serialize=False, verbose_name='ID del Servicio')),
                ('nombre_servicio', models.CharField(max_length=30, unique=True, verbose_name='Nombre del Servicio')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Servicio_Orden',
            fields=[
                ('id_servicio_orden', models.AutoField(primary_key=True, serialize=False, verbose_name='ID del Servicio en la Orden')),
                ('terminado', models.BooleanField(default=False, verbose_name='Terminado')),
                ('id_orden_trabajo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='concesionarioapp.orden_trabajo')),
                ('id_servicio', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='concesionarioapp.servicio')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Repuesto_Orden',
            fields=[
                ('id_repuesto_orden', models.AutoField(primary_key=True, serialize=False, verbose_name='ID del Repuesto en la Orden')),
                ('id_orden_trabajo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='concesionarioapp.orden_trabajo')),
                ('id_rep', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='concesionarioapp.repuesto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_modelo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='concesionarioapp.modelo')),
                ('id_repuesto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='concesionarioapp.repuesto')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_repuesto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='concesionarioapp.repuesto')),
                ('id_sucursal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='concesionarioapp.sucursal')),
            ],
            options={
